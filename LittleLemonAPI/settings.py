...
SECRET_KEY = 'django-insecure-zaz=$9iqpq#l8$jvsccqsr8c!8)9#5_m-ezgt-hk9z&-vsg22h'
...
REST_FRAMEWORK['DEFAULT_THROTTLE_RATES'] = {
    'user': '5/minute',  # 5 запитів на хвилину для кожного користувача
}
